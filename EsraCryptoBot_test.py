    ...
    if spread > 0:
        if (depths['final_USD'] - depths['initial_USD'])/depths['initial_USD'] > 0:
            ...
            arbitrage = {
                ...
                'sym_list': arb_list,
                'profit': (depths['final_USD'] - depths['initial_USD'])/depths['initial_USD'],
                'quantity_list': depths['quantity_list'],
    ...
    if spread > 0:
        if (depths['quantity_coin1_final'] - depths['quantity_coin1'])/depths['quantity_coin1'] > 0:
            ...
            arbitrage = {
                ...
                'sym_list': arb_list,
                'profit': (depths['quantity_coin1_final'] - depths['quantity_coin1'])/depths['quantity_coin1'],
                'quantity_list': depths['quantity_list'],
                'fee_percentage': fee_percentage
            }
            return arbitrage
