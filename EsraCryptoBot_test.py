...
with open('triarbdata.csv', 'w') as f:
    ...
    def writeToCSV(arbitrageopp):
        i = 0
        if (i == 0):
            thewriter.writerow({'Bot_Start_Date': current_time.date(), 'Bot_Start_Time': current_time.time(), 'Arb_Time': current_time.now(), 'Exchange': arbitrageopp['exchange'], 'Initial_USD': arbitrageopp['initialUSD'], 'First_Market': arbitrageopp['sym_list'] [0], 'Second_Market': arbitrageopp['sym_list'] [1], 'Third_Market': arbitrageopp['sym_list'] [2], 'Spread': arbitrageopp['spread'], 'Estimated_Profit': arbitrageopp['estimated_profit']})
        else:
            thewriter.writerow({'Arb_Time': current_time.now(), 'Exchange': arbitrageopp['exchange'], 'Initial_USD': arbitrageopp['initialUSD'], 'First_Market': arbitrageopp['sym_list'] [0], 'Second_Market': arbitrageopp['sym_list'] [1], 'Third_Market': arbitrageopp['sym_list'] [2], 'Spread': arbitrageopp['spread'], 'Estimated_Profit': arbitrageopp['estimated_profit']})
        i+=1
